                                        ...
                                        <div class="col-12 col-md-6 pb-2 px-1">
                                            <select name="sector" class="form-control py-2">
                                                ...
                                                @foreach($sectors as $sector)
                                                    <option value="{{ $sector->id }}" {{ $sector->id == $selected_manager->sector_id ? 'selected' : '' }}>{{ $sector->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-12 col-md-6 pb-2 px-1">
                                        ...
                                        <div class="col-12 col-md-6 pb-2 px-1">
                                            <select name="line" class="form-control py-2">
                                                ...
                                                @foreach($lines as $line)
                                                    <option value="{{ $line->id }}" {{ $line->id == $selected_manager->line_id ? 'selected' : '' }}>{{ $line->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
