...
@section('panel_content')
    <div class="container px-4">
        ...
        @endif
        <div id="audio_err" class="alert alert-danger text-center m-auto mb-2 col-12 col-lg-8" role="alert" style="display:none;">
                        ...
                        <div class="overflow-scroll border bg-white shadow rounded-2 py-5 px-4 px-lg-5">
                            ...
                            <form action="{{ route('audios.store') }}" method="POST" enctype="multipart/form-data" id="audioForm">
                                ...
                                <div class="col-md-10 col-12 d-inline-block">
                                    <div class="pb-3">
                                        <input type="text" name="name" class="form-control py-2" value="{{ old('name') }}" placeholder="Audio Name">
                                    </div>
                                    <div class="pb-3">
                                        <input type="file" name="audio" id="audio" class="form-control py-2" accept="audio/*" placeholder="Audio File">
                                    </div>
                                ...
                                <div class="col-md-10 col-12 m-auto">
                                    <button class="btn submit_btn p-2 my-3 w-100" onclick="checkFileSize()" id="submitButton">Add audio</button>
