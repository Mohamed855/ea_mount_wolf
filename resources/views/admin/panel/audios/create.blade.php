...
@section('panel_content')
    <div class="container px-4">
        <div id="audio_success" class="alert alert-success text-center m-auto mb-2 col-12 col-lg-8" role="alert" style="display:none;"></div>
        <div id="audio_err" class="alert alert-danger text-center m-auto mb-2 col-12 col-lg-8" role="alert" style="display:none;"></div>
    </div>
                ...
                <div class="row text-center">
                    <div class="col-12 col-lg-8 m-auto">
                        <div class="overflow-scroll border bg-white shadow rounded-2 py-5 px-4 px-lg-5">
                            <h3 class="pb-4">Add New Audio</h3>
                            ...
                            <form action="{{ route('audios.store') }}" method="POST" enctype="multipart/form-data" id="audioForm">
                                @csrf
                                ...
                                <div class="col-md-10 col-12 m-auto">
                                    <button class="btn submit_btn p-2 my-3 w-100" onclick="uploadAudio()" id="submitButton">Add audio</button>
                            ...
                            <script>
                                function uploadAudio() {
                                    ...
                                    let audioErr = document.getElementById('audio_err');
                                    let audioSuccess = document.getElementById('audio_success');
                                    if (fileInput.files.length > 0) {
                                        let fileSizeMB = fileInput.files[0].size / (1024 * 1024);
                                        let maxFileSizeMB = 300;
                                        if (fileSizeMB > maxFileSizeMB) {
                                            audioErr.innerHTML = "The file is too big. Maximum allowed size is 300 MB.";
                                        ...
                                        form.addEventListener("submit", function(event) {
                                            ...
                                            xhr.open("POST", "{{ route('audios.store') }}");
