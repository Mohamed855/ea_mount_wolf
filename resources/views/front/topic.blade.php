...
@section('content')
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <div class="brain-box ratio ratio-16x9 element-bg"
                             style="background-image: url({{ public_path('images/topics/'.$current_topic->image) }})">
                        </div>
                        ...
                        <div class="comments-section brain-box-comments">
                            @foreach($comments_details as $comment_details)
                                <div class="comment-box">
                                    ...
                                    public_path('images/profile_images/'.$comment_details->profile_image)
                                ...
                                <div class="comment-box write-comment">
                                    <div class="comment-info">
                                        <div class="prof-pic bg-styles" style="background-image:url({{
                                            ...
                                            public_path('images/profile_images/default_profile_image.jpg') :
                                            public_path('images/profile_images/'.$user_details->profile_image)
                                         }}); max-width: 50px; max-height: 50px">
                                        </div>
                                    ...
                                    <div class="comment-txt">
                                        <div class="input-group mb-3">
                                            ...
                                            <button class="btn btn-outline-secondary" type="submit" id="button-addon2">
                                                <img src="{{ public_path('images/icons/send.png') }}" style="max-width: 20px">
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    @if($topic->id != $current_topic->id)
                                        <a href="{{ route('topic', $topic->id) }}">
                                            <div class="topic-box element-bg"
                                                 style="background-image: url({{ public_path('images/topics/' . $topic->image) }})">
                                                {{ $topic->title }}
                                            </div>
                                        </a>
                                    @endif
    ...
    <script src="{{ public_path('assets/js/owl.carousel.js') }}"></script>
    <script>
