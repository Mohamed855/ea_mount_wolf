                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 pb-5">
                        <p class="d-inline fs-4">
                            Files Details
                            <a href="{{ route('ea_files.create') }}" class="btn btn-success mx-3">Add New</a>
                        </p>
                    </div>
                    <div class="col-lg-12">
                        <table class="table mb-0 bg-white">
                            ...
                            @foreach($files as $file)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('file', $file->id) }}" class="btn btn-outline-primary btn-sm btn-rounded">
                                            View
                                        </a>
                                        <form action="{{ route('toggle_show', $file->id) }}" method="post" class="d-inline">
                                            @csrf
