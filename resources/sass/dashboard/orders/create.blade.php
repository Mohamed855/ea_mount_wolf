                ...
                <div class="row text-center">
                    <div class="col-12 col-lg-8 m-auto">
                        <div class="overflow-scroll border bg-white shadow rounded-2 py-5 px-4 px-lg-5">
                            <h3 class="pb-4">@lang('panel.addNew') @lang('panel.order')</h3>
                            <form action="{{ route('orders.store') }}" method="POST">
                                ...
                                <div class="col-md-5 col-12 d-inline-block">
                                    ...
                                    <div class="pb-3">
                                        <input type="email" name="email" class="form-control py-2" value="{{ old('email') }}" placeholder="@lang('panel.email')">
                                    </div>
                                </div>
                                <div class="col-md-5 col-12 d-inline-block">
                                    <div class="pb-3">
                                        <input type="text" name="phone" class="form-control py-2" value="{{ old('phone') }}" placeholder="@lang('panel.phone')">
                                    </div>
                                    <div class="pb-3">
                                        <input type="text" name="company" class="form-control py-2" value="{{ old('company') }}" placeholder="@lang('panel.company')">
                                    </div>
                                </div>
                                <div class="col-md-10 col-12 m-auto">
                                    <div class="pb-3">
                                        <textarea name="order" id="" rows="4" class="form-control py-2" placeholder="@lang('translate.order')" style="text-align:right">{{ old('order') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-10 col-12 m-auto">
