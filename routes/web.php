...
// Admin
Route::get('admin', [AdminLoginController::class, 'adminLogin']) -> name('adminLogin');
Route::post('admin', [AdminLoginController::class, 'admin_check_credentials']) -> name('admin_check_credentials');
Route::get('admin_logout', [AdminLoginController::class, 'logout']) ->middleware('auth') -> name('admin_logout');
// Dashboard
...
Route::post('toggle_publish_announcement/{id}', [ActionsController::class, 'toggle_publish_announcement'])->name('toggle_publish_announcement');
Route::post('toggle_publish_topic/{id}', [ActionsController::class, 'toggle_publish_topic'])->name('toggle_publish_topic');
Route::post('toggle_show_file/{id}', [ActionsController::class, 'toggle_show_file'])->name('toggle_show_file');
